...
if (GENOMEBUILD=="hg19") {
	...
	CHROM_COORD_FILE = "/opt/battenberg_reference/gcCorrect_chromosome_coordinates_hg19.txt"
	...
	CHROM_COORD_FILE = "/opt/battenberg_reference/gcCorrect_chromosome_coordinates_hg38.txt"
}
