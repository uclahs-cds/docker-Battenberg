...
RUN cat /usr/local/lib/R/site-library/Battenberg/example/battenberg_wgs.R | \
    ...
    sed 's|REPLICCORRECTPREFIX = \".*|REPLICCORRECTPREFIX = \"/opt/battenberg_reference/battenberg_wgs_replication_timing_correction_1000_genomes/1000_genomes_replication_timing_chr\"|' > /usr/local/bin/battenberg_wgs.R
